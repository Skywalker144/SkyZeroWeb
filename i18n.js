...
const I18N_STRINGS = {
    en: {
        ...
        status_ai_thinking_n: (n, nps) => "AI thinking · " + (n || 0).toLocaleString() + " sims" + (nps ? " · " + nps.toLocaleString() + "/s" : ""),
        status_black_wins: "Black wins!",
        status_white_wins: "White wins!",
        status_draw: "Draw!",
        status_analyzing_n: (n, nps) => "Analyzing · " + (n || 0).toLocaleString() + " sims" + (nps ? " · " + nps.toLocaleString() + "/s" : ""),
        status_analysis_ready_n: (n) => "Analysis · " + (n || 0).toLocaleString() + " sims",
        tb_label_mode: "Mode",
        tb_label_side: "Side",
        mode_play: "Play",
        ...
        cand_analyze_on: "Analyze my turn",
        aria_analyze_toggle: "Toggle analysis of my turn",
    ...
    zh: {
        ...
        status_ai_thinking_n: (n, nps) => "AI 思考中 · " + (n || 0).toLocaleString() + " 次模拟" + (nps ? " · " + nps.toLocaleString() + " 次/秒" : ""),
        status_black_wins: "黑方获胜!",
        status_white_wins: "白方获胜!",
        status_draw: "和棋!",
        status_analyzing_n: (n, nps) => "分析中 · " + (n || 0).toLocaleString() + " 次模拟" + (nps ? " · " + nps.toLocaleString() + " 次/秒" : ""),
        status_analysis_ready_n: (n) => "分析就绪 · " + (n || 0).toLocaleString() + " 次模拟",
        tb_label_mode: "模式",
        tb_label_side: "执子",
        mode_play: "对弈",
        mode_analysis: "分析",
        ...
        cand_analyze_on: "开启我的回合分析",
        aria_analyze_toggle: "切换我的回合分析",
